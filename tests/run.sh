...
node "$here/sdl.test.mjs"
node "$here/legacy-panel.test.mjs"
node "$here/legacy-lites.test.mjs"
node "$here/legacy-grilles.test.mjs"
node "$here/mahogany-photos.test.mjs"
node "$here/design-gallery.test.mjs"
